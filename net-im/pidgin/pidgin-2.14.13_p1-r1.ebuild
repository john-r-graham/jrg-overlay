...
KEYWORDS=""
IUSE="aqua dbus debug doc eds gadu gnutls groupwise +gstreamer +gui idn sounds-only
...
src_install() {
	if use sounds-only ; then
		insinto "/usr/share/sounds/purple"
		doins share/sounds/*.wav
	else
